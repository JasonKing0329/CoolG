...
/**
 * 扩展DefaultMediaController，替换xml，保留大部分原有的Id与功能代码
 * 加入扩展的UI元素及状态变化
 * @Jing Yang注释的部分为扩展部分
 */
public class FullMediaController extends BaseMediaController {
...
//            $.id(R.id.app_video_fullscreen).invisible();
    ...
    protected View makeControllerView() {
        return LayoutInflater.from(context).inflate(R.layout.layout_video_controller, videoView, false);
    }
...
//                doPauseResume();
    ...
    protected void initView(View view) {
        ...
        $.id(R.id.app_video_last).clicked(onClickListener);
        $.id(R.id.app_video_list).clicked(onClickListener);
